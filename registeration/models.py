...
class Event(models.Model):
	...
	Time_CHOICES = (('0', '9:00 a.m.'),('1', '10:00 a.m.'),('2', '11:00 a.m.'),('3', '12:00 a.m.'),('4', '1:00 p.m.'),('5', '2:00 p.m.'),('6', '3:00 p.m.'),('7', '4:00 p.m.'),('8', '5:00 p.m.'),('9', '6:00 p.m.'))
	...
	def save(self, *args, **kwargs):
		...
		if temp.Actual_time != self.past_Actual_time or temp.Actual_day != self.past_Actual_day  :
			...
			for user in u:
				...
				receivers.append(xx)
			#print xx
			send_notif.sendmail_to_registered(receivers,self.name,self.event_coordi,self.contact_id_coordinator,self.Venue,self.get_Actual_time_display(),self.get_Actual_day_display())
